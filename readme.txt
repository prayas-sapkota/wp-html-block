...
1. Unzip the wp-html-block.zip file.
2. Upload 'wp-html-block' folder to the '/wp-content/plugins/' directory
3. Activate the plugin through the 'Plugins' menu in WordPress
4. Go to the HTML Block menu and add new Block.
5. Copy shortcode and paste where ever you want to disply.
